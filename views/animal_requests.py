...
def get_all_animals():
    ...
    with sqlite3.connect("./kennel.sqlite3") as conn:
        ...
        for row in dataset:
            ...
            # add dict representations of the location and customer to the animal.
            animal.location = location.__dict__
            animal.customer = customer.__dict__
            
            #add dict representation of the animal to the list
...
def delete_animal(id):
    """FN to delete an animal record based on the id as an argument"""
    with sqlite3.connect("./kennel.sqlite3") as conn:
        db_cursor = conn.cursor()
